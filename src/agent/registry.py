...
class RegistryClient:
  ...
  async def check_agent_registration(
      ...
      if self.subgraph and agent_address:
          ...
          if agent_data and agent_data.get('agentId'):
              ...
              print(f"  Subgraph returned no data - check SUBGRAPH_API_KEY")
      ...
      if agent_id is not None:
          ...
          if result["verified"]:
              ...
              print(f"  Fast verification failed for agent ID {agent_id}")
      ...
      try:
          if agent_address:
              ...
              if balance > 0:
                  ...
                  print(f"  Agent has NFT but ID unknown (subgraph unavailable)")
                  ...
                  print(f"ℹ  Address has no NFTs (not registered)")
  ...
  async def verify_agent_by_id(
      ...
      try:
          ...
          print(f"  Fast verification failed for agent ID {agent_id}: {e}")
